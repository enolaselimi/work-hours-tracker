...
if(!isset($_SESSION['emp_id']) || !isset($_SESSION['role'])){
    ...
    ';
    $q = "SELECT CONCAT(c.fname,' ',c.lname) AS emp, a.type, b.leave_id, b.from_date, b.to_date, b.return_date, b.comments, b.leave_status 
        FROM leavetypes AS a 
            INNER JOIN 
        leaves AS b ON a.type_id = b.type
            INNER JOIN 
        users AS c ON b.emp_id = c.emp_id
        WHERE b.leave_status = 'pending'";
...
<br/>
<div class="col-md-6">
    <input type="text" name="search_text" id="search_text" placeholder="Search by Appointment Details" class="form-control" />
</div>
...
while($row = mysqli_fetch_array($r, MYSQLI_ASSOC)){
    ...
    <td align="center"><a style="color:rgb(101, 160, 136);" href="approve.php?id=' . $row['leave_id'].'">Approve</a>  <a style="color:rgb(219, 131, 131);" href="reject.php?id=' . $row['leave_id'].'">Reject</a></td> 
    </tr>
    ';
}
?>
